...
import styles from "./sendPrivateMessagePaneFreightStyles.js";
...
const RBSheetSendPrivateMessageFreightListingHelper = ({ listing, authData, setStateOutter, sendPrivateMessageRef }) => {
    ...
    const sendPrivateMessage = () => {
        ...
        console.log("sendPrivateMessage clicked/ran...!", listing.postedByID);

        const receiverID = listing.postedByID;
                ...
                <KeyboardAwareScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps='always' contentContainerStyle={{ paddingBottom: 225 }}>
                    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1 }}>
                        <View style={styles.flexedTopContainer}>
                            <Text style={[styles.labelTextInput, { marginBottom: 16.25 }]}>Enter your <Text style={{ fontWeight: "bold", textDecorationLine: "underline", color: Colors.secondaryColor }}>subject</Text> to {listing.postedByName} for your message...</Text>
                            <FloatingLabelInput
                            ...
                            <Text style={styles.labelTextInput}>Enter your message to be sent <Text style={{ fontWeight: "bold", textDecorationLine: "underline", color: Colors.secondaryColor }}>privately</Text> to {listing.postedByName} A.K.A. {listing.postedByUsername}</Text>
                            <FloatingLabelInput
                                isPassword={false}
                                maxLength={275}
                                staticLabel={true}
...
export default RBSheetSendPrivateMessageFreightListingHelper;