                ...
                <View style={{ flex: 1, paddingBottom: Sizes.fixPadding * 6.0 }}>
                    <ScrollView>
                        ...
                        >
                            {informations(
                                {
                                    icon: <Icon name="person-sharp" size={26} color="black" />,
                                    title: 'Edit Profile',
                        ...
                        >
                            {informations(
                                {
                                    icon: <Icon name="bank" size={29} color="black" />,
                                    title: 'Bank Details',
                        ...
                        <View style={{ marginVertical: Sizes.fixPadding }}>
                            ...
                            >
                                {informations(
                                    {
                                        icon: <Icon name="headset-mic" size={29} color="black" />,
                                        title: 'Help & Support',
                            ...
                            >
                                {informations(
                                    {
                                        icon: <Icon name="privacy-tip" size={29} color="black" />,
                            ...
                            {informations(
                                {
                                    icon: <Icon name="star-outline" size={27} color="black" />,
                                    title: 'Rate Us',
                        ...
                        {informations(
                            {
                                icon: <Icon name="android" size={29} color="black" />,
                                title: 'About CryptoX',
                                description: 'v1.0.0'
                            }
                        )}
            ...
            <TouchableOpacity
                ...
                <View style={styles.informationContainerStyle}>
                    <View style={styles.iconContainerStyle}>
                        <Icon name="login-variant" size={29} color="black" />
                    </View>
        ...
        <View style={{ alignItems: 'center', marginVertical: Sizes.fixPadding * 2.0 }}>
            <View>
                ...
                <View style={styles.imageVerifySignContainerStyle}>
                    {<Icon name="check" size={24} color={Colors.whiteColor} />}
                </View>
            </View>
