...
import styles from "./sheetOneStyles.js";
import { ListItem, List, Left, Body, Right, Icon, Title, Subtitle, Header, Button } from "react-native-elements"; // WAS NATIVE-BASE
...
const mapStateToProps = (state) => {
    return {
        unique_id: state.authData.unique_id,
        fullName: `${state.authData.firstName} ${state.authData.lastName}`
    };
}
