                            ...
                            <TouchableOpacity onPress={() => {}} style={styles.avatarImageTouchable}>
                                <View style={styles.rowOnly}>
                                    <View style={styles.smallerRowContainer}>
                                        ...
                                        <Text style={styles.rightTextAlongImage}><Text style={{ color: Colors.primaryColor }}>{item.mainData.distanceAndDuration.distance.toFixed(2)}</Text> mi's</Text>
                                    </View>
                                </View>
                            </TouchableOpacity>
                        </View>
                            ...
                            <TouchableOpacity onPress={() => {}} style={styles.avatarImageTouchable}>
                                <View style={styles.rowOnly}>
                                    <View style={styles.smallerRowContainerLonger}>
                                        <Image source={require("../../../assets/images/icon/cart-64.png")} style={styles.superSmallIconImage} />
                                        <Text style={styles.rightTextAlongImage}><Text style={{ color: Colors.secondaryColor }}>{item.mainData.distanceAndDuration.duration.toFixed(2)}</Text> Est. Min(s)</Text>
                                    </View>
                                </View>
                            </TouchableOpacity>
                        </View>
