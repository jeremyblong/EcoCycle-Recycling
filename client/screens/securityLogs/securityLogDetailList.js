...
import styles from "./securityLogDetailListStyles.js";
        ...
        return (
            <View style={styles.listTopContainer}>
                <View style={styles.centeredTopPortion}>
                    <View style={styles.middleChunkTextWrapper}>
                        <Text style={styles.middleText}>These are your previous security-related log's</Text>
                    </View>
                </View>
                <Svg
                    height={275}
                    ...
                    <View style={styles.rowItem}>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                ...
                                <Text style={styles.bulletItem}>{deviceName}</Text>
                            </View>
                        </View>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                <Text style={styles.labelText}>IP Address:</Text>
                                <Text style={styles.bulletItem}>{ipAddress}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.rowItem}>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                ...
                                <Text style={styles.bulletItem}>{deviceModel}</Text>
                            </View>
                        </View>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                <Text style={styles.labelText}>Device Unique-ID:</Text>
                                <Text style={styles.bulletItem}>{deviceUniqueId}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.rowItem}>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                ...
                                <Text style={styles.bulletItem}>{deviceType}</Text>
                            </View>
                        </View>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                <Text style={styles.labelText}>Brand:</Text>
                                <Text style={styles.bulletItem}>{brand}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.rowItem}>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                ...
                                <Text style={styles.bulletItem}>{systemName}</Text>
                            </View>
                        </View>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                <Text style={styles.labelText}>System Version:</Text>
                                <Text style={styles.bulletItem}>{systemVersion}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.rowItem}>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                ...
                                <Text style={styles.bulletItem}>{tabletOrNot === true ? "Not A Tablet..." : "Device IS A Tablet!"}</Text>
                            </View>
                        </View>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                <Text style={styles.labelText}>Device ID:</Text>
                                <Text style={styles.bulletItem}>{deviceID}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.rowItem}>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                ...
                                <Text style={styles.bulletItem}>{typeof carrier !== "undefined" && carrier.length > 0 ? carrier : "Carrier Couldn't Be Detected..."}</Text>
                            </View>
                        </View>
                        <View style={styles.halfColumnOnly}>
                            <View style={styles.columned}>
                                <Text style={styles.labelText}>Manufacturer:</Text>
                                <Text style={styles.bulletItem}>{manufacturer}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.rowItem}>
                        <View style={styles.fullColumnOnly}>
                            <View style={styles.columnedBottom}>
                                ...
                                <Text style={styles.bulletItem}>{userAgent}</Text>
                            </View>
                        </View>
                    </View>
                    <Card.Divider />
                    <Text style={styles.bottomedText}>Logged/Occurred <Text style={styles.underlinedBoldText}>{moment(dateOfOccurance).fromNow()}</Text> at <Text style={styles.underlinedBoldText}>{dateOfOccuranceString}</Text></Text>
                </Card>
                <View style={styles.renderedItemHR} />
            </Fragment>
        );
    }
