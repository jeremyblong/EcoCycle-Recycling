            ...
            <KeyboardAwareScrollView>
                <View style={styles.container}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 12.5, marginBottom: 12.5 }}>
                        ...
                        <View>
                            <Text style={{ width: 175, textAlign: 'center', color: Colors.primaryColor }}>Your selected country is below</Text>
                        </View>
                        <View style={{ flex: 1, height: 1, backgroundColor: 'black' }} />
                    </View>
                    ...
                    <View style={styles.spacerContainer}>
                        <Button disabled={calculateDisabledLocation()} color={Colors.primaryColor} onPress={() => {
