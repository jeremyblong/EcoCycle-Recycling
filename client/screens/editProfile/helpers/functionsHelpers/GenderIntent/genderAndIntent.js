...
const GenderAndIntentHelper = (props) => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <ScrollView contentContainerStyle={{ paddingBottom: 50 }}>
                <View style={styles.container}>
                        ...
                        <View style={{ maxWidth: "35%", minWidth: "35%" }}>
                            <View style={{ position: "absolute", right: 20, top: 0 }}>
                                <Switch
                                    ...
                                    circleActiveColor={Colors.greenColor}
                                    circleInActiveColor={Colors.primaryColor}
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 40, marginBottom: 12.5 }}>
                        ...
                        <View>
                            <Text style={{ width: 180, textAlign: 'center', color: Colors.primaryColor }}>Maritial Status</Text>
                        </View>
                        <View style={{ flex: 1, height: 1, backgroundColor: 'black' }} />
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 40, marginBottom: 12.5 }}>
                        <View style={{ flex: 1, height: 1, backgroundColor: 'black' }} />
                        <View>
                            <Text style={{ width: 180, textAlign: 'center', color: Colors.primaryColor }}>What's your preference?</Text>
                        </View>
                        <View style={{ flex: 1, height: 1, backgroundColor: 'black' }} />
                    </View>
                    <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 40, marginBottom: 12.5 }}>
                        <View style={{ flex: 1, height: 1, backgroundColor: 'black' }} />
                        <View>
                            <Text style={{ width: 180, textAlign: 'center', color: Colors.primaryColor }}>What type of relationship do you want?</Text>
                        </View>
                        <View style={{ flex: 1, height: 1, backgroundColor: 'black' }} />
                    </View>
                    <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 40, marginBottom: 12.5 }}>
                        <View style={{ flex: 1, height: 1, backgroundColor: 'black' }} />
                        <View>
                            <Text style={{ width: 180, textAlign: 'center', color: Colors.primaryColor }}>What is your intent (honestly)?</Text>
                        </View>
                        <View style={{ flex: 1, height: 1, backgroundColor: 'black' }} />
                    </View>
                    <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
            ...
            <View>
                <Button disabled={calculateReadiness()} color={Colors.secondaryColor} onPress={() => {
                    handleSubmisison();
