...
import styles from "./commentReplySheetHelperStyles.js";
...
const RBSheetReplyToCommentHelper = ({ listing, authData, currentlySelected, setStateOutter, refSheetCommentReply }) => {
    ...
    const handleCommentReplySubSubmission = () => {
        ...
        axios.post(`${BASE_URL}/post/new/subcomment/comment/dropoff/listing`, config).then((res) => {
...
export default RBSheetReplyToCommentHelper;